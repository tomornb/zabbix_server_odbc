...
COPY msodbcsql-11.0.2270.0.tar.gz
RUN tar -zxvf /tmp/msodbcsql-11.0.2270.0.tar.gz -C /tmp/msodbcsql-11.0.2270.0
RUN /tmp/msodbcsql-11.0.2270.0/install install --force --accept-license
